    ...
    >
      ...
      <div class="flex items-center">
        <div v-if="withSelect" class="append flex relative">
          <button
            @click="toggleSearch"
            class="flex text-primary border-accent border-2 items-center rounded-3px py-2 px-3 text-sm sm:text-base whitespace-no-wrap flex-shrink-0 focus:outline-none"
          >
